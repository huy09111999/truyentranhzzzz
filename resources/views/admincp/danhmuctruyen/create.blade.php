                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{route('danhmuc.store')}}">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="{{old('slug')}}" name="slug_danhmuc" id="convert_slug" aria-describedby="emailHelp" placeholder="Tên danh mục...">                       
                      </div>      
                      <div class="form-group">
                        <label for="exampleInputEmail1">Mô tả danh mục</label>
                        <input type="text" class="form-control" value="{{old('tendanhmuc')}}" name="mota" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Mô tả danh mục...">                       
                      </div>     
